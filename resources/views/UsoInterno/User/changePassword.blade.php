                ...
                <div class="col-12 col-md-8 col-lg-5">
                    <div class="card border-0 shadow-sm rounded-4 h-100">
                        <div class="card-body p-4 p-lg-5">
                            <div class="mb-4">
                                <h1 class="h4 fw-bold text-success mb-1">Cambiar contrasena</h1>
                            ...
                            <form method="POST" action="{{ route('change-password') }}" class="d-grid gap-3">
                                @csrf
                                <div>
                                    <label for="current_password" class="form-label fw-semibold">Contrasena actual</label>
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-secondary password-toggle" type="button" data-toggle="password"
                                            data-target="current_password" aria-label="Mostrar contrasena">
                                            <span data-eye="open">
                                                <x-fluentui-eye-20-o />
                                            </span>
                                ...
                                <div>
                                    <label for="new_password_confirmation" class="form-label fw-semibold">Confirmar nueva contrasena</label>
                                    <div class="input-group">
